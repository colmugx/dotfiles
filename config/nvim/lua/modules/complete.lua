local Module = { {
  ...
  build = ":MasonUpdate",
  dependencies = { "williamboman/mason.nvim", "williamboman/mason-lspconfig.nvim", "ray-x/lsp_signature.nvim",
    "folke/neodev.nvim", "SmiteshP/nvim-navic", "jose-elias-alvarez/null-ls.nvim",
    "jose-elias-alvarez/nvim-lsp-ts-utils", "tami5/lspsaga.nvim" },
  config = function()
    local map_opt = {
      noremap = true,
      silent = true
